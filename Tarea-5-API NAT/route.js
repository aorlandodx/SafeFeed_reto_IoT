...
const temperaturaController = require('./RestControllers/sensorMetales.js'); 
...
router.get(constants.contextURL + constants.api + constants.getDetectSensor, temperaturaController.getLogSensor);
router.post(constants.contextURL + constants.api + constants.getDetectSensorByDate, temperaturaController.getLogDetectSensorByDate);
router.post(constants.contextURL + constants.api + constants.postMetalSensor,temperaturaController.insertLogMetalSensor);
